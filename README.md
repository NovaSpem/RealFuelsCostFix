...
### Key Features:
* **Perfect Cost Symmetry:** Fueling a tank increases the price correctly based on real Community Resource Pack (CRP) liter costs. Emptying a tank smoothly transitions the cost, locking the dry tank shell exactly at its factory value (e.g., 275 funds).
